...
var (
	...
	AllUnionProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, nil, &UnionConfig{Period: 0, Epoch: 5000}}
...
type ChainConfig struct {
	...
	Union  *UnionConfig  `json:"clique,omitempty"`
}
...
// UnionConfig is the consensus engine configs for proof-of-stake-authority based sealing.
...
// String implements the stringer interface, returning the consensus engine details.
func (c *UnionConfig) String() string {
	return "union"
}
