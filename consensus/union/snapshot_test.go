...
// checkpoint creates a Union checkpoint signer section from the provided list
...
// sign calculates a Union digital signature for the given block and embeds it
...
// the account may or may not have cast a Union vote.
...
// Tests that Union signer voting is evaluated correctly for various simple and
...
func TestUnion(t *testing.T) {
	...
	for i, tt := range tests {
		...
		config.Union = &params.UnionConfig{
			Period: 1,
			Epoch:  tt.epoch,
		}
		engine := New(config.Union, db)
		...
		// Pass all the headers through union and ensure tallying succeeds
